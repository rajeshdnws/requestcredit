...
class MassAccept extends \Magento\Backend\App\Action
{
     ...
     * @param $item
     */
    protected function setTimeUpdate($item)
    {
        $timeUpdate = $this->datetime->gmtDate('Y-m-d H:i:s');
        $item->setData('updated_at', $timeUpdate);
        $item->save();
    }
    ...
    protected function _isAllowed()
    {
        return $this->_authorization
            ->isAllowed("Starbucksb2b_RequestCredit::requestcredit_access_controller_request_massaccept");
    }
}
